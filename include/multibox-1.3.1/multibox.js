...
var MultiBox = new Class({
	...
	createEmbedObject: function(){
		...
		if(this.type == 'flashVideo'){
			...
			this.str += 'title="MultiBoxMedia">';
  			this.str += '<param name="movie" value="'+this.options.path+'osflv_player_v3/player.swf" />'
  			this.str += '<param name="allowFullScreen" value="true" />';
  			this.str += '<param name="salign" value="TL" />';
  			this.str += '<param name="scale" value="noScale" />';
  			this.str += '<param name="FlashVars" value="movie='+url+'&autoload=on&autorewind=on&autoplay=on" />';
  			this.str += '<embed src="'+this.options.path+'osflv_player_v3/player.swf" ';
  			this.str += 'quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" ';
  			this.str += 'width="'+this.contentObj.width+'" ';
  			this.str += 'height="'+(Number(this.contentObj.height)+this.contentObj.xH)+'"';
  			this.str += 'salign="TL" ';
  			this.str += 'scale="noScale" ';
  			this.str += 'FlashVars="movie='+url+'&autoload=on&autorewind=on&autoplay=on"';
  			this.str += '></embed>';
			this.str += '</object>';
